            ...
            <div class="section__content section__content--p30">
                <div class="container-fluid">
                  <div class="row">
                    ...
                    <div class="col-lg-9">
                        <div class="card">
                            <div class="card-header">Edit Pengelola</div>
                            <div class="card-body">
                              <form method="POST" action="{{route('pengelola/update',$user->id)}}"  enctype="multipart/form-data">
                                    @csrf
