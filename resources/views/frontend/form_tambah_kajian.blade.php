            ...
            <div class="section__content section__content--p30">
                <div class="container-fluid">
                  <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">Tambah Kajian</div>
                            <div class="card-body">
                              <form method="POST" action="{{ route('kajian/store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <select id="kategori_id" name="kategori_id" class="form-control @error('kategori_id') is-invalid @enderror">
                                            <!-- <option value="val1" id="valid1"> pilih kategori </option> -->
                                    ...
                                    <div id="judul_kajian" class="form-group row">
                                        ...
                                        <div  class="col-md-6">
                                            <input type="text" class="form-control  @error('judul_kajian') is-invalid @enderror" name="judul_kajian" value="{{ old('judul_kajian') }}" >
                                            @error('judul_kajian')
                                    ...
                                    <div id="deskripsi_kajian" class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <textarea name="deskripsi_kajian" id="summernote"  rows="3" class="form-control @error('deskripsi_kajian') is-invalid @enderror" value="{{ old('deskripsi_kajian') }}" >{{ old('deskripsi_kajian') }}</textarea>
                                    ...
                                    <div id="nama_ustadz" class="form-group row ">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control @error('nama_ustadz') is-invalid @enderror" name="nama_ustadz" value="{{ old('nama_ustadz')}}">
                                            @error('nama_ustadz')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group row">
                                       <label class="col-md-4 col-form-label text-md-right">Waktu Kegiatan</label>
                                       ...
                                       <div class="col-md-6">
                                           ...
                                           <input type="text"
                                             ...
                                             required onkeypress="return false;"
                                              class="datepicker-here date readonly form-control @error('waktu_kajian') is-invalid @enderror"
                                              data-language='en'
                                               data-timepicker="true"
                                              data-time-format='hh:ii aa'
                                              value="{{ old('waktu_kajian') }}"/>
                                              <small class="form-text text-muted text-justify">jadwal kajian akan otomatis di buka 2 hari sebelum jadwal kajian dan diakhiri 5 jam sebelum kajian dimulai</small>
                                              @error('waktu_kajian')
                                                  <span class="invalid-feedback" role="alert">
                                                      <strong>{{ $message }}</strong>
                                                  </span>
                                          ...
                                          <input type="text "
                                            ...
                                            readonly="readonly"
                                             ...
                                             data-language='en'
                                              data-timepicker="true"
                                             data-time-format='hh:ii aa'
                                             value="{{ old('pendaftaran_dibuka') }}"

                                             data-position='top left'/>
                                             <small  class="form-text text-muted text-justify">custom pembukaan pendaftaran</small>
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input  type="text" class="form-control @error('batas_jumlah_ikhwan') is-invalid @enderror" name="batas_jumlah_ikhwan" value="{{old('batas_jumlah_ikhwan') }}" required>
                                    ...
                                    <div id="batas_jumlah_akhwat" class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input   type="text" class="form-control  @error('batas_jumlah_akhwat') is-invalid @enderror" name="batas_jumlah_akhwat" value="{{old('batas_jumlah_akhwat') }}">
                                  ...
                                  <div  hidden class="form-group row">
                                    ...
                                    <div id="foto_banner" class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div id="#foto_banner" class="form-group">
